...
class GameTest < Minitest::Test
  ...
  def test_a_minion_that_was_placed_exists_on_the_board
    # skip
    test_game = Game.new(3)
    test_game.add_player('P1', max_mana: 5, summoning_zone: [[0, 0], [0, 1], [0, 2], [1, 0], [1, 1], [1, 2], [2, 0], [2, 1], [2, 2]])
  ...
  def test_skeletons_can_only_move_1_square_diagonally_and_2_straight
    ...
    test_game.add_player('P1', max_mana: 5, summoning_zone: [[0, 0], [0, 1], [0, 2], [0, 3], [1, 0], [1, 1], [1, 2], [1, 3], [2, 0], [2, 1], [2, 2], [2, 3], [3, 0], [3, 1], [3, 2], [3, 3]])
    skelly = test_game.place(owner: 'P1', type: 'skeleton', x: 0, y: 0)
    target_field = Position.new(2, 2)
  ...
  def test_skeleton_can_attack_within_1_square
    ...
    test_game = Game.new(3)
    test_game.add_player('P1', max_mana: 5, summoning_zone: [[0, 0], [0, 1], [0, 2], [1, 0], [1, 1], [1, 2], [2, 0], [2, 1], [2, 2]])
    test_game.add_player('P2', max_mana: 5, summoning_zone: [[0, 0], [0, 1], [0, 2], [1, 0], [1, 1], [1, 2], [2, 0], [2, 1], [2, 2]])
    skelly = test_game.place(owner: 'P1', type: 'skeleton', x: 0, y: 0)
  ...
  def test_summoning_minions_costs_mana
    ...
    test_game.add_player(test_player_name, max_mana: 5, summoning_zone: [[0, 0], [0, 1], [0, 2], [1, 0], [1, 1], [1, 2], [2, 0], [2, 1], [2, 2]])
  ...
  def test_cant_summon_minions_with_insufficient_mana
    test_game = Game.new(3)
    test_player_name = 'Mateusz'
    test_game.add_player(test_player_name, max_mana: 0, summoning_zone: [[0, 0], [0, 1], [0, 2], [1, 0], [1, 1], [1, 2], [2, 0], [2, 1], [2, 2]])
